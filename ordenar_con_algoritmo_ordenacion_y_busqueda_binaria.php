...
* @param string $algoritmo_ordenacion Le pasamos tambien que tipo de algoritmo de ordenacion vamos a utilizar
* @param string $numero_busqueda_binaria Le pasaremos el numero que quiere buscar por busqueda binaria
* @return string Nos retornara un string con un texto indicando el tipo de algoritmo de ordenacion elegido seguido de los numeros ordenados y tambien nos informa si ha encontrado el numero por busqueda binaria y de su posicion 
*/
function ordenarConAlgoritmoOrdenacionYBusquedaBinaria($array_numeros, $algoritmo_ordenacion, $numero_busqueda_binaria){
